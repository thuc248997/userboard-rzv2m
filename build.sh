...
function print_boot_example() {
	echo ""
	echo ">> FOR MMC BOOT"
	echo -e "${YELLOW} => setenv bootmmc 'setenv bootargs rw rootwait earlycon root=/dev/mmcblk0p2; fatload mmc 1:1 0x48080000 Image; fatload mmc 1:1 0x48000000 r8a774a1-hihope-rzg2m-rev2-ex.dtb; booti 0x48080000 - 0x48000000' ${NC}"
	echo -e "${YELLOW} => run bootmmc ${NC}"
	echo ""
	echo ">> FOR SD BOOT"
	echo -e "${YELLOW} => setenv bootsd 'setenv bootargs rw rootwait earlycon root=/dev/mmcblk1p2; fatload mmc 0:1 0x48080000 Image; fatload mmc 0:1 0x48000000 r8a774a1-hihope-rzg2m-rev2-ex.dtb; booti 0x48080000 - 0x48000000' ${NC}"
	echo -e "${YELLOW} => run bootsd ${NC}"
	echo ""
	echo ">> FOR USB BOOT"
	echo -e "${YELLOW} => setenv bootusb 'setenv bootargs rw rootwait earlycon root=/dev/sda2; usb reset; fatload usb 0:1 0x48080000 Image; fatload usb 0:1 0x48000000 r8a774a1-hihope-rzg2m-rev2-ex.dtb; booti 0x48080000 - 0x48000000' ${NC}"
	...
	echo -e "${YELLOW} => setenv boottftp 'tftp 0x48080000 Image; tftp 0x48000000 r8a774a1-hihope-rzg2m-rev2-ex.dtb; setenv bootargs rw rootwait earlycon root=/dev/nfs nfsroot=\${NFSROOT},nfsvers=3 ip=dhcp; booti 0x48080000 - 0x48000000' ${NC}"
	echo -e "${YELLOW} => setenv bootnfs 'nfs 0x48080000 \${NFSROOT}/boot/Image; nfs 0x48000000 \${NFSROOT}/boot/r8a774a1-hihope-rzg2m-rev2-ex.dtb; setenv bootargs rw rootwait earlycon root=/dev/nfs nfsroot=\${NFSROOT},nfsvers=3 ip=dhcp; booti 0x48080000 - 0x48000000' ${NC}"
